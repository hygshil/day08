...
public class DouDiZhuTest {
    public static void main(String[] args) {
        ...
        if(player1.contains("♥3") && diPai.contains("♥3")){
            player1.add(String.valueOf(diPai));
        }
        if(player2.contains("♥3") && diPai.contains("♥3")){
            player2.add(String.valueOf(diPai));
        }
        if(player3.contains("♥3") && diPai.contains("♥3")){
            player3.add(String.valueOf(diPai));
        }
        System.out.println("player1 = " + player1);
        System.out.println("player2 = " + player2);
        System.out.println("player3 = " + player3);
